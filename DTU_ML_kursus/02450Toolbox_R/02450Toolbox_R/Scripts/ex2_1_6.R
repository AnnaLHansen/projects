...
#X_s = X # Make a to be "scaled" version of X
...
Y1 <- t(apply(X,1,'-',colMeans(X))) # subtract the column means form columns of X
...
# It might be easier to study the plot if you maximize the plots tab
par(mfcol=c(3,2), pty='s')    # set the plotting area into a 3*2 array
